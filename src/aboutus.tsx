    ...
    <div id="aboutus">
      <div className="hero-wrapper" style={{ position: "relative" }}>
        ...
        <div className="herosection">
          <h1 className="smartone">About Us</h1>
          <br />
          ...
          <div className="hero-buttons">
            <button className="getStarted" onClick={onBack}>
              Go Home
            </button>
      ...
      <div className="ourmission">
        <div className="missiontext">
          ...
          <p>
            ...
            spikes, <span>Spacklock</span> instantly sends alerts and <br />
          ...
          <div>
            ...
            <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
              {[
                ...
                { label: "Contact Us", action: () => onGoToContact() },
              ].map((link) => (
